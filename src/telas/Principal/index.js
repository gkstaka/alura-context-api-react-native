...
export default function Principal({ navigation }) {
    ...
    // console.log(ultimosVistos.length);
    ...
    return (
        <View style={estilo.container}>
                ...
                <View style={estilo.carrinhoArea}>
                    ...
                    {quantidade > 0 && (
                        <View style={estilo.carrinhoQuantidadeArea}>
                            <Text style={estilo.carrinhoQuantidade}>
                                {quantidade}
                            </Text>
                        </View>
                    )}
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <Produto item={item} adicionar={true} />
                )}
                style={estilo.lista}
                    ...
                    <View>
                        {ultimosVistos.length > 0 && (
                            <View style={estilo.ultimosVistos}>
                                <Text style={estilo.tituloUltimosVistos}>
                                    Últimos vistos
                                </Text>
                                <FlatList
                                    data={ultimosVistos}
                        ...
                        <Text style={[estilo.titulo, { paddingLeft: 16 }]}>
                            Produtos
                        </Text>
                    </View>
                )}
